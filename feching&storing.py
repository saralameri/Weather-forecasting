...
c.setopt(
    c.URL,
    "http://api.openweathermap.org/data/2.5/weather?q=Paris&APPID=4d260396d5b19dc31ea21f597ac164ef&units=metric",
)
c.setopt(c.WRITEDATA, buffer)

with psycopg.connect(
    "postgres://ergenznr:KuW9kFZvxTrguNmwENy6SMMIFXEUKXRe@jelani.db.elephantsql.com/ergenznr"
) as conn:
    while True:
      # emptying the buffer
      buffer.seek(0)
